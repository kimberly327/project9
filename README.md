...
```bash
project9$ sam logs -n StockCheckerFunction --stack-name project9 --tail
```
...
```bash
project9$ cd functions/stock-checker
...
```bash
aws cloudformation delete-stack --stack-name project9
```
